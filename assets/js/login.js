        ...
        setTimeout(() => {
          switch (response.role) {
            case "mahasiswa":
              ...
              break;
            case "admin_prodi":
              window.location.href = "programstudi/dashboard.html";
              break;
            case "admin_akademik":
              window.location.href = "akademik/dashboard.html";
              break;
            case "admin_perpus":
              window.location.href = "perpustakaan/dashboard.html";
              break;
            default:
              showAlert(
                "warning",
                "Peringatan",
                "Role tidak dikenali atau halaman tidak tersedia."
              );
          }
        }, 2000);
      } else {
