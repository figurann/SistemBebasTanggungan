function showAlert(title, message, type = "error") {
  ...
  const buttonHTML = isSuccess
    ? "" // Tidak ada tombol untuk success
    : '<button class="alert-button error">OK</button>'; // Tombol hanya untuk error
  ...
  // Event listener untuk tombol OK hanya jika tipe alert adalah error
  if (!isSuccess) {
