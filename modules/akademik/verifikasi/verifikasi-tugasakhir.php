...
<head>
    ...
    <title>Verifikasi Tugas Akhir - Sistem Bebas Tanggungan</title>

    <!-- Favicon -->
    <link rel="shortcut icon" href="../../assets/images/logo_polinema.png" type="image/x-icon">
    <!-- CSS -->
    <link rel="stylesheet" href="../../../assets/css/akademik/verifikasi/verifikasi-tugasakhir.css">
    <!-- Font Awesome -->
...
<body>
    <div class="container">
        <div class="page-header">
            <div class="header-content">
                ...
                <h1 class="page-title">Verifikasi Tugas Akhir</h1>
            </div>
    ...
    <!-- JavaScript -->
    <script src="../../../assets/js/akademik/verifikasi/verifikasi-tugasakhir.js"></script>
</body>
